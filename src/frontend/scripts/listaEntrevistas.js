...
axios.get(`https://plf-es-2022-2-ti2-0924100-recrutech-t-git-26faaa-recrutech-tis2.vercel.app/listar-candidatos-entrevista?codVaga=${idDaVaga}`)
  .then(response => {
...
const incrementarQuantidadeUsuariosContratados = () => {
  axios.put(`https://plf-es-2022-2-ti2-0924100-recrutech-t-git-26faaa-recrutech-tis2.vercel.app/atualizar-quantidade-usuContratados?codVaga=${idDaVaga}`)
    .then(response => {
      if (response.status === 200) {
        console.log(response.data);
      }
...
const enviarEmailPositivo = (codUsuario) => {
  axios.get(`https://plf-es-2022-2-ti2-0924100-recrutech-t-git-26faaa-recrutech-tis2.vercel.app/enviar-email-final?codUser=${codUsuario}`)
    .then(response => {
      if (response.status === 200) {
        console.log(response.data);
      }
...
const atualizarIndiceAprovacao = (codUsuario, indAprovado) => {
  axios.put(`https://plf-es-2022-2-ti2-0924100-recrutech-t-git-26faaa-recrutech-tis2.vercel.app/atualizar-indice-aprovacao-entrevista?codCandidato=${codUsuario}&codVaga=${idDaVaga}&indAprovado=${indAprovado}`)
    .then(response => {
      if (response.status === 200) {
        console.log(response.data);
      }
...
const enviarDadosEntrevista = (codigoUsuario) => {
  ...
  axios.put(`https://plf-es-2022-2-ti2-0924100-recrutech-t-git-26faaa-recrutech-tis2.vercel.app/atualizar-dados-entrevista?codUsuario=${codigoUsuario}&codVaga=${idDaVaga}`, {
