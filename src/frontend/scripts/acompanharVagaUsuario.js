...
const obterUrlCurriculo = () => {
  axios.get(`https://plf-es-2022-2-ti2-0924100-recrutech-t-git-26faaa-recrutech-tis2.vercel.app/listar-curriculos?codVaga=${idDaVaga}`)
    .then(response => {
      if (response.status === 200) {
...
const obterUrlTeste = async () => {
  await axios.get(`https://plf-es-2022-2-ti2-0924100-recrutech-t-git-26faaa-recrutech-tis2.vercel.app/obter-teste?codVaga=${idDaVaga}`)
    .then(response => {
      if (response.status === 200) {
...
const uploadTeste = (dadosInscricao) => {
  axios.post('https://plf-es-2022-2-ti2-0924100-recrutech-t-git-26faaa-recrutech-tis2.vercel.app/enviar-teste', {
...
const preencherDadosEntrevista = async () => {
  await axios.get(`https://plf-es-2022-2-ti2-0924100-recrutech-t-git-26faaa-recrutech-tis2.vercel.app/obter-dados-entrevista?codVaga=${idDaVaga}&codCandidato=${codigoUsuario}`)
    .then(response => {
      if (response.status === 200) {
...
const indicarStatusProcesso = async () => {
  await axios.get(`https://plf-es-2022-2-ti2-0924100-recrutech-t-git-26faaa-recrutech-tis2.vercel.app/acompanhar-status-vaga?codCandidato=${codigoUsuario}&codVaga=${idDaVaga}`)
    .then(response => {
      if (response.status === 200) {
