...
const redirecionar = async (codigo) => {
  try {
    const res = await fetch(`https://plf-es-2022-2-ti2-0924100-recrutech-t-git-26faaa-recrutech-tis2.vercel.app/remove-vaga/${codigo}`, {
      method: 'GET',
      headers: {
...
const fecharVaga = async(codVaga) => {
  axios.get(`https://plf-es-2022-2-ti2-0924100-recrutech-t-git-26faaa-recrutech-tis2.vercel.app/obter-qtd-vagas?codVaga=${codVaga}`)
  .then(response => {
...
const fecharVagaPut = async (codVaga) => {
  axios.put(`https://plf-es-2022-2-ti2-0924100-recrutech-t-git-26faaa-recrutech-tis2.vercel.app/fechar-vaga?codVaga=${codVaga}`)
  .then(response => {
...
const res = fetch(
  `https://plf-es-2022-2-ti2-0924100-recrutech-t-git-26faaa-recrutech-tis2.vercel.app/lista-vagas-criadas/${codigoUsuario}`,
  {
    method: 'GET',
    headers: {
      Accept: 'application/json',
...
async function getItems() {
  ...
  const data = await fetch(`https://plf-es-2022-2-ti2-0924100-recrutech-t-git-26faaa-recrutech-tis2.vercel.app/lista-vagas-criadas/${codigoUsuario}`, {
    method: "GET",
    headers: headers,
