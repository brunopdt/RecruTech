...
axios.get(`https://plf-es-2022-2-ti2-0924100-recrutech-tis2.vercel.app/listar-testes-vagas?codVaga=${idDaVaga}`)
  .then(response => {
...
const enviarEmailPositivo = (codUsuario) => {
  axios.get(`https://plf-es-2022-2-ti2-0924100-recrutech-tis2.vercel.app/enviar-email?codUser=${codUsuario}`)
    .then(response => {
      if (response.status === 200) {
        console.log(response.data);
      }
...
const atualizarIndiceAprovacao = (codUsuario, indAprovado) => {
  axios.put(`https://plf-es-2022-2-ti2-0924100-recrutech-tis2.vercel.app/atualizar-indice-aprovacao-teste?codCandidato=${codUsuario}&codVaga=${idDaVaga}&indAprovado=${indAprovado}`)
    .then(response => {
      if (response.status === 200) {
        console.log(response.data);
      }
